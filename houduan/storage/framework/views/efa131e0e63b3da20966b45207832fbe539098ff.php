...
<?php $__env->startSection('page-content'); ?>
    ...
    <div class="larry-personal-body clearfix">
        <form class="layui-form col-lg-5">
            ...
            <?php if(!empty($google['qrcode'])){ ?>
            <div class="layui-form-item">
                <label class="layui-form-label">谷歌二维码</label>
                <div class="layui-input-block">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="authcode" autocomplete="off" class="layui-input" value="" placeholder="">
                </div>
            </div>
            <input type="hidden" name="google" value="<?php echo e($google['secret']); ?>">
            <?php } ?>
