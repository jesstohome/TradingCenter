export default {
	...
	common: {
		...
		newPassword_new: "Entrer un nouveau mot de passe",
		confirmNewPassword_new: "Confirmez le nouveau mot de passe",
		new_password_botton: "Connecte-toi",
		email: "E - mail",
		...
		mobilecodePlaceholder: "Le code de vérification",
		emailcodePlaceholder: "Le code de vérification",
		send: "Envoyer",
	...
	home: {
		...
		bottom_title: "Suivez les meilleurs commerçants et gagnez de l'argent",
		bottom_title_desc: "Vous pouvez copier les stratégies d'excellents traders, suivre automatiquement les ordres et réaliser des bénéfices",
		bottom_button:"Expérimentez maintenant"
	},
	setting: {
		country: "Nation",
		confirm_new: "Confirmer",
		cancel_new: "Annuler",
		...
		share: "Partager",
		success_tips: "Copier avec succès",
		service: "Servez",
		general: "Général",
		levelDesc: "À propos du niveau VIP",
		fkhd: "Dernières activités de bien-être",
		flhd_desc: "Veuillez garder un œil sur les actualités sur la page d'accueil pour en savoir plus sur notre dernière politique en matière d'événements !",
	...
	fund: {
		transaction_password: "Mot de passe des transactions",
	...
	mailMessage: {
		...
		kf: "Message du service client",
		system: "Informations système",
		center: "Annonce de la plateforme",
		detail_botton: "Détails",
		detail_message: "Détails du message",
		gg: "Annonce"
	},
	buyCrypto: {
		bankName: "Virement",
		three: "Tierce personne",
		currency: "Choisissez la devise et le mode de paiement",
		corresponding: "Veuillez sélectionner la devise correspondante",
		payment: "Mode de paiement",
		continue: "Continuez",
		problem: "Problème commun",
		swift: "Qu'est-ce que SWIFT ?",
		swift_desc: "Les virements SWIFT vous permettent d'acheter des crypto-monnaies à partir de comptes bancaires dans des centaines de pays.Les transactions d'achat de crypto-monnaie seront traitées avec succès dans les 2 à 5 jours ouvrables suivant la fin du paiement SWIFT de votre banque.Wire Transfer vous permet d'acheter des crypto-monnaies avec un compte bancaire américain via le système FedWire.Si vous avez des questions sur le paiement, veuillez contacter le service client en ligne.",
		deposit_input: "Veuillez entrer le montant que vous souhaitez déposer",
		amount: "le montant",
		amount_input: "Veuillez entrer le montant",
		receive: "Vous allez recevoir",
		rate: "Taux de change 1:1 entre USD et USDT",
		bankAccount: "Ajouter un compte bancaire",
		fee: "Frais de gestion",
		buy: "Acheter maintenant",
		notice: "Remarquer",
		desc: "Pour les frais de virement bancaire, veuillez vous référer aux frais bancaires de remiseSeul le montant réel reçu peut être converti en USDTSi les informations sont saisies de manière incorrecte, le montant peut être retourné sur le compte de remise. Des frais bancaires peuvent s'appliquer.Si vous avez des questions sur le paiement, veuillez contacter le service client en ligne",
		over: "Veuillez effectuer le transfert dès que possible, sinon votre commande sera annulée.",
		information: "Information sur le compte",
		transfer: "Veuillez utiliser votre propre compte pour transférer vers le compte bancaire suivant",
		account_name: "Nom du compte",
		iban: "IBAN",
		beneficiary_country: "Pays bénéficiaire",
		bank_code: "Code bancaire (BIC/SWIFT)",
		bank_name: "om de banque",
		bank_address: "Adresse de la banque",
		transfer_amount: "Montant du transfert",
		photo: "Vous ne vous souvenez pas ? enregistrer dans l'album photo",
		transfer_over: "Transfert terminé",
		screenshot: "Veuillez télécharger une capture d'écran du transfert",
		image_desc: "Notez que le format de l'image doit être :",
		upload: "Télécharger",
		will_receive: "Je vais recevoir",
		want_spend: "Je veux dépenser",
		copy: "Copie",
		submit_error: "Votre région n'est temporairement pas prise en charge !",
		select_payment_method: "Veuillez sélectionner le mode de paiement",
		online_bank: "banque en ligne",
		scan_code_payment: "paiement par scan code",
		bank_payment: "paiement bancaire",
		direct_bank: "banque directe",
		please_enter_information: "veuillez saisir les informations",
		the_minimum_amount_is: "Le montant minimum d'achat est",
		please_enter_an_integer: "Veuillez saisir un entier",
		payment_successful: "paiement réussi",
		to_be_paid: "Être payé",
		please_select_a_country: "Veuillez sélectionner un pays",
		please_select_currency: "Veuillez sélectionner la devise",
		quickly_buy_coins: "Achetez rapidement des pièces",
		wallet: "portefeuille",
		bank_transfer: "Virement",
		credit_card: "VSA/MasterCard",
		please_select_a_bank: "Veuillez sélectionner une banque",
		rate_desc: "Le taux de conversion USDT est",
		payer_first_name: "nom du payeur",
		payer_last_name: "nom de famille du payeur",
		payer_email: "Courriel du payeur",
		payer_phone: "téléphone du payeur",
		payer_cpf: "ID fiscal du payeur",
		payer_full_name: "nom du payeur",
		wallet_payment: "paiement portefeuille",
		usa: "U.S.A",
		nigeria: "Nigeria",
		thailand: "Thaïlande",
		indonesia: "Indonésie",
	...
	downLoad_new: {
		...
		one_title: "Ouvrez des transactions à tout moment, n'importe où",
		one_desc: "Ouvrez des transactions à tout moment, n'importe où",
		two_one_title: "Sécurité",
		two_one_desc: "Portefeuille froid multi-signatures de stockage d'actifs numériques",
		two_two_title: "Majeur",
		two_two_desc: "Plus de 10 ans d'équipe de contrôle des risques financiers, prenant en charge les transactions API",
		two_three_title: "Stabiliser",
		two_three_desc: "Équipe technique mondiale, technologie parallèle distribuée, appariement des transactions à grande vitesse"
	},
	contact: {
		title: "Nous contacter",
		contactUs: "Un service en ligne",
		jie: "Agent de crédit",
		huankuan: "Spécialiste du remboursement"
	},
	guess: {
		various_quiz: "Quizz Divers",
		popular: "Populaire",
		daily_quiz: "Quiz Quotidien",
		my_bet: "Mon pari",
		cut_off: "Couper",
		has_not_started: "N'a pas commencé",
		guessing: "Devinant",
		over: "Plus De",
		unsettlement: "Déstabilisation",
		people_participated: "Personnes ont participé",
		...
		guess_right: "Devine juste",
		bonus_distribution: "Distribution de dividendes",
		missed: "Manqué"
	},
	borrowing: {
		info: "Sûr et conforme",
		borrow_now: "Prêt",
		one: "Service de prêt VIP personnalisé",
		one_desc: "Le montant maximal du prêt est de 10 millions USDT et le soutien maximal est de 3 X. La limite de prêt comprend BTC, ETH, USDT, etc.",
		two: "Niveau des taux d'intérêt",
		two_desc: "Plus le niveau Prime est élevé, plus le montant du prêt est élevé et plus le taux d'intérêt est bas",
		three: "Utilisation flexible des fonds",
		three_desc: "La durée du prêt commence à partir de 30 jours et vous pouvez rembourser au fur et à mesure que vous empruntez",
		four: "Processus de prêt simplifié",
		four_desc: "1-3 jours pour compléter le prêt",
		middle_info: "Comment emprunter",
		middle_one: "Remplissez le formulaire de demande de prêt",
		middle_two: "Confirmation des besoins de prêt",
		middle_three: "Signer le contrat de prêt",
		middle_four: "Prêt de titres de fonds",
		bottom_info: "Begin Your Loan",
		bottom_info_desc: "Veuillez entrer vos besoins de prêt et vos coordonnées",
		bottom_info_one: "Montant du prêt souhaité (à partir de 500 000 USDT ou équivalent)",
		bottom_info_one_desc: "Entrez la devise et la quantité",
		bottom_info_two: "Devise de marge",
		bottom_info_three: "Détails du contact",
		bottom_info_three_desc: "Veuillez entrer votre UID",
		submit: "Prêt",
		faq_1: "Quelles conditions doivent être remplies pour utiliser les prêts OTC ?",
		faq_1_desc: "Teneurs de marché sur cette plateforme ou clients ayant un niveau VIP ≥ 2 et des capacités de trading professionnelles, ou clients professionnels avec des conditions équivalentes sur d'autres plateformes",
		faq_2: "Quelles sont les crypto-monnaies pouvant être empruntées ?",
		faq_2_desc: "Les devises d'emprunt comprennent BTC, ETH, USDT, USDC, 4 devises (mettez à jour régulièrement la marge et la liste des devises empruntables, et les devises populaires qui répondent aux exigences de contrôle des risques seront mises à jour à temps)",
		faq_3: "Quelle est la durée du prêt pour les prêts OTC ?",
		faq_3_desc: "Cycle de prêt flexible : 7 jours à 1 an, le prêt peut être remboursé à tout moment et le prêt peut être renouvelé à l'échéance",
		faq_4: "Comment calculer les intérêts ?",
		faq_4_desc: "Les intérêts sont calculés quotidiennement. Si le remboursement est en retard, 0,5 % de l'actif total du prêt sera facturé sous forme d'intérêts par jour.",
		faq_5: "Comment rembourser le capital et les intérêts ?",
		faq_5_desc: "Les intérêts sont réglés à la fin de chaque mois ou les fonds et les intérêts sont remboursés à la fin de la période.",
		faq_6: "Puis-je payer à l'avance ?",
		faq_6_desc: "Oui, pendant la durée du prêt, l'utilisateur peut augmenter le prêt, rembourser par anticipation et différer le remboursement.",
		faq_7: "Comment sera-t-il traité en cas de défaut pendant la durée du prêt ?",
		faq_7_desc: "En cas de rupture de contrat, la plate-forme peut résilier cet accord à tout moment et demander à l'utilisateur de restituer le principal et les intérêts restants.Le contrôle des risques surveillera le risque d'actif du prêt du client en temps opportun.Si le taux de risque est inférieur à 110%, la plateforme sera La position sera fermée.",
		faq_8: "Puis-je retirer mes actifs de prêt?",
		faq_8_desc: "Si les exigences de taux de risque de retrait sont remplies, les actifs d'emprunt et les dépôts peuvent être retirés, mais la fonction principale des prêts de gré à gré est de soutenir la transaction entre l'utilisateur et le contrat au comptant et au comptant + de la bourse.",
		faq_9: "Comment réaliser un prêt OTC ?",
		faq_9_desc: "Vous pouvez contacter nos spécialistes des prêts pour un traitement accéléré et des réponses rapides à vos questions."
	}
}
