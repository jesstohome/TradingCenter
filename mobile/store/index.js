...
const store = new Vuex.Store({
	state: {
		...
		//process.env.NODE_ENV模式为本地调式环境，'/api'为自动获取当前访问域名加/api，如果打包独立app需要把/api换为完整的https://xxx.com/api
		//自动获取域名模式
		baseUrl: process.env.NODE_ENV === 'development' ? 'https://m.cosimok.com/api' : "/api",
		//自动获取域名模式
		baseDomain: process.env.NODE_ENV === 'development' ? 'https://m.cosimok.com' : window.location.origin,
		//指定模式
		//baseUrl: 'https://m.cosimok.com/api',
		//指定模式
		//baseDomain: 'https://m.cosimok.com',
