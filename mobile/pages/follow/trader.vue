<template>
	<view class="pb-60 text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.traderList"></u-navbar>
		<view class="mx-30 mt-30">
			<view class="box-shadow bg-white border-radius-20 pt-30 pb-40 px-28 mb-12">
				<view class="d-flex align-items-center justify-content-between">
					...
					<view class="d-flex align-items-baseline py-14 px-20 mt-20 border-radius-20 bg-333" style="background: black !important; color: white !important;">
			...
			<view class="product">
				...
				<view class="d-grid text-center opacity-50 font-size-22 py-20 align-items-center" style="grid-template-columns:1.2fr .5fr 1fr 1fr 1.2fr;grid-column-gap:10rpx">
				...
				<view class="d-grid text-center py-20 align-items-center" style="grid-template-columns:1.2fr .5fr 1fr 1fr 1.2fr;grid-column-gap:10rpx" v-for="item in historyOrder">
