<template>
	<view class="pb-30 text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.traderList">
		...
		<view class="mx-30 mt-30" >
			<image src="../../static/img/trade-banner.png" style="width: 100%; height: 208rpx; background: rgb(255, 255, 255);"></image>
			<view class="deposit bg-white" v-if="false">
