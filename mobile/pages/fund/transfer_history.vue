<template>
	<view>
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.financialRecords"></u-navbar>
		<view class="m-30">
