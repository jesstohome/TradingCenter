<template>
	<view class="">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.delegateList" :custom-back="backTo"></u-navbar>
		<u-sticky>
			...
			<view class="p-30" style="background-color: rgb(236, 239, 244);">
				<u-subsection :list="nav" :current="current" @change="changeNav"></u-subsection>
			</view>
		</u-sticky>
		<view class="list">
			<view class="p-30 border-bottom text-white" v-for="item in list">
				<view class="d-flex">
					<view class="d-flex align-items-center">
