<template>
	<view class="" style="color: #fff;">
		...
		<view class="px-20 py-30">
			...
			<view class="d-grid mt-20 align-items-center" style="grid-template-columns:1.2fr 2fr">
				...
				<view class="overflow-hidden" style="height: 780rpx;" v-if="buyList.length">
					<view class="d-flex-between-center font-size-22 opacity-50 pb-10">
				...
				<view class="pl-20 position-relative opacity-90" style="height: 780rpx;">
					...
					<view class="mt-20 position-relative">
						...
						<text class="position-absolute opacity-50" style="bottom: 16rpx;right: 20rpx;">{{currency_name}}</text>
					</view>
					...
					<view class="position-absolute" style="left: 20rpx;right: 0;bottom: 0;">
						<text class="d-block mb-10 opacity-50">{{i18n.jye}}：{{jiaoyie}}</text>
		...
		<view class="mx-20">
			<view class="d-grid py-20 font-size-22 opacity-50" style="grid-template-columns:.8fr 1fr 1.4fr 1.3fr .7fr;">
