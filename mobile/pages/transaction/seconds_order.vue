<template>
	<view class="text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="`${i18n.secondsPosition}(${symbol})`" :custom-back="()=>{$utils.jump('/pages/transaction/index','switchTab')}"></u-navbar>
		<view class="p-30">
