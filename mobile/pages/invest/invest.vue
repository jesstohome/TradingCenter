<template>
	<view class="text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.invest">
		...
		<view class="m-30">
			...
			<view class="mt-30">
				<view class="box-shadow border-radius-20 mb-20 bg-white" v-for="item in invest">
					<text class="px-20 py-20 d-block font-size-32">{{item.name}}</text>
					<view class="p-20">
						<view class="py-10">
