<template>
	<view class="text-white">
		...
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.myPosition"></u-navbar>
		<view class="m-30">
			<!-- 一级菜单 -->
			...
			<view class="mt-30">
				<view class="box-shadow border-radius-20 mb-20 bg-white" v-for="item in invest">
					<view class="d-flex-between-center px-20 py-20  font-size-32">
						<text>{{item.name}}</text>
