<template>
    <div class="k-line-area bg-1d1d29" style="display: flex;flex-direction: row;">
      <div id="showMaketList" v-show="showMarketlist" @mouseover="showMarketList" @mouseout="closeMarketList" style="position: absolute; background: rgb(19, 24, 30); top: 25px; z-index: 999; width: 175px; height: 450px; overflow: auto; display: none;">
        <market></market>
      </div>
      <div class="flex column ml3" style="background: #181d25; flex:1;margin-right: 5px;">
        <div class="info-wrap" style="height: 50px; margin: 0px !important; padding: 0px !important;">
            <div @mouseover="showMarketList" @mouseout="closeMarketList" style="display: flex; align-items: center; flex-direction: inherit; background: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKBAMAAAB/HNKOAAAAG1BMVEUAAADN1uTN1uTN1uTN1uTN1uTN1uTN1uTN1uQDLfgAAAAACHRSTlMAwyRp55YPQu9xBBsAAAApSURBVAjXY0AGER0dHa0MjEBSgIHNo6MlgYFBo6MJKMHeUQCSN2ZAAQAemAg9/FQSTAAAAABJRU5ErkJggg==') 100% center / 10px no-repeat;">
                {{ rightName }}/{{ leftName }}
                <span :class="change>=0?'green':'red'" style="margin-left: 10px;">{{(change - 0).toFixed(2)}}%</span>
            </div>
        </div>
      </div>
    </div>
