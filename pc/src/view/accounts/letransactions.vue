<template>
  <div class="_page-main__content1">
      ...
      <div class="_page-tab _flex-shrink" style="padding: 0px 40px; background: white;">
        ...
        <a href="#/letransactions" class="_page-tab-li router-link-exact-active router-link-active" >{{$t("change.option_asset")}}</a>
      </div>
      <div class="_page-main__content__main" style="overflow: auto; padding: 0px 40px; background: white;">
          ...
          <div class="_page-main__content__table">
              ...
              <ul class="content_ul" style="overflow: auto;">
                  <li v-for="(item,index) in asset_list" :key="index" v-if="item.is_micro == 1">
                      <div class="content_li flex alcenter between">
                          ...
                          <p class="flex1 tc">{{item.usdt_price * item.micro_balance || "0.00"|toFixedTwo}}</p>
              ...
              <div class="mt24">
                  ...
                  <div class="flex alcenter mt15">
                      <div class="flex1 is-disabled">
                          <el-input disabled style="background-color:transparent!important;border-color:#E5E7ED!important" :value='$t("change.option_asset")'></el-input>
                      </div>
      ...
      methods: {
          ...
          getNum(t) {
              ...
              this.$http({
                  ...
                  e.balance = t.message.lock_micro_balance,
          ...
          loadData(e){
              ...
              var s = e.data.message.micro_wallet;
          ...
          transfer(t, e) {
              ...
              a.submitForm.blanace = e.micro_balance
          },
          uploadFile(t) {
              let e = this
                  , a = new FormData;
