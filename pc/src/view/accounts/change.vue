<template>
    <div class="_page-main__content1">
        ...
        <div class="_page-tab _flex-shrink" style="padding: 0px 40px; background: white;">
            <a href="#/change" aria-current="page" class="_page-tab-li router-link-exact-active router-link-active"> {{$t("trade.change")}} </a>
            <a href="#/finance" class="_page-tab-li">{{$t("change.contract_assets")}}</a>
        ...
        <div class="_page-main__content__main" style="overflow: auto; padding: 0px 40px; background: white;">
            ...
            <div class="_page-main__content__table">
                <div class="content_top flex alcenter fColor2">
                    ...
                    <p class="tc" style="width: 500px;">{{$t("leverTransactions.do")}}</p>
                </div>
                <ul class="content_ul" style="overflow: auto;">
                    <li v-for="(item,index) in asset_list" :key="index" v-if="item.is_match == 1">
                        <div class="content_li flex alcenter between">
                            ...
                            <p class="tc operation" style="width: 500px;">
                                <el-button  
                                    class="btn_new" 
                                    type="primary"
                                    style="background-color: transparent !important;color:#000"
                                    size="mini" @click="jumpDeposit" v-if='item.is_charge'>
                                    {{$t("dealTv.top_up")}}
                                </el-button>
                                <el-button  
                                    class="btn_new" 
                                    type="primary"
                                    style="background-color: transparent !important;color:#000"
                                    size="mini" @click="jumpWithdraw" v-if='item.is_charge'>
                                    {{$t("change.withdraw")}}
                                </el-button>
                                <el-button  
                                    class="btn_new" 
                ...
                <div class="mt24">
                    ...
                    <div class="flex alcenter mt15">
                        <div class="flex1 is-disabled">
                            <el-input disabled style="background-color:transparent!important;border-color:#E5E7ED!important" :value='$t("trade.change")'></el-input>
                        </div>
                        ...
                        <div class="flex1 _from-white">
                            <el-select v-model="submitForm.to_field" :placeholder='$t("change.please_select_an_account")'>
                                <el-option value="lever" :label='$t("change.contract_assets")'></el-option>
        ...
        methods: {
            ...
            getNum(t) {
                ...
                this.$http({
                    ...
                    e.balance = t.message.change_balance,
            ...
            loadData(e){
              ...
              var s = e.data.message.change_wallet;
            ...
            transfer(t, e) {
                ...
                a.submitForm.blanace = e.change_balance
            },
            uploadFile(t) {
                let e = this
                    , a = new FormData;
