<template>
    <div style="background: #F7F7FA;">
      ...
      <div class="setTransactionPassword bg-main">
        ...
        <div class="from-box">
            <h1 class="from-box__title">{{$t("accountSet.revise")}} {{$t("login.password_placeholder")}}</h1>
            <div class="tab flex around">
                <!-- <span class="now border-primary">{{$t("login.login_tabItem_0")}}</span> -->
            </div>
            <div class="register-box">
                ...
                <input v-model="user_string" type="text" readonly="readonly" placeholder="请输入邮箱" id="account" autocomplete="off" class="phone flex1 codeinput">
            </div>
            <div class="flex input_sty alcenter plr20 mt30">
                ...
                <input v-model="password" :placeholder='$t("login.password")' maxlength="16" id="pwd" autocomplete="off" type="password" class="plr20 emil"> 
            ...
            <div class="flex input_sty alcenter plr20 mt30">
                ...
                <input v-model="re_password" :placeholder='$t("login.password")' maxlength="16" id="repwd" autocomplete="off" type="password" class="plr20 emil"> 
                <img width="20px" height="14px" src="data:image/png;base64," alt="" class="pointer">
            </div>
        ...
        userInfo() {
            ...
            this.$http({
                ...
                if ("ok" == e.data.type) {
                    ...
                    t.userDetail.mobile || (t.active = 1,
                    t.user_string = t.userDetail.email),
